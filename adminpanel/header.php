        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="examcat.php"> <i class="menu-icon fa fa-dashboard"></i>Add & Edit Exam </a>
                    </li>
                       <li>
                        <a href="add_edit_questions.php"> <i class="menu-icon fa fa-dashboard"></i>Add & Edit Questions </a>
                    </li>
                     <li>
