...
<body>
				...
				<div class="hpanel">
                    <div class="panel-body">
                        <form action="" name ="form1" method="post">
                            ...
                            <div class="alert alert-danger" id="error" style = "display: none;margin-top: 10px">
   ...
   <?php
    ...
    {
        $count = 0;
        $res = mysqli_query($link,"select * from registration where uname = '$_POST[username]' && password = '$_POST[password]'");
        ...
        else
        {
            ...
            ?>     
            <script type = "text/javascript">
            window.location = "exam_select.php";
            </script>
            <?php
        }
    }
